...
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as renderSlot } from '../astro_B6h7vYUJ.mjs';
import 'kleur/colors';
/* empty css                        */
import 'clsx';
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_kHjYHjrm.mjs';
/* empty css                        */
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_kHjYHjrm.mjs'
    ).then(n => n.s).catch((e) => {
...
const logo = new Proxy({"src":"/_astro/reset_logo.D0aqhu3a.svg","width":90,"height":90,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Documents/プログラミング学習/atama_reset/reset website/src/assets/reset_logo.svg";
							}
...
const logo2 = new Proxy({"src":"/_astro/reset_logo2.peyb8uM2.svg","width":122,"height":73,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Documents/プログラミング学習/atama_reset/reset website/src/assets/reset_logo2.svg";
							}
...
const $$GlobalNavLeft = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="globalNav" id="js-globalNavLeft" data-astro-cid-iws3qlhb> <div class="container" data-astro-cid-iws3qlhb> <img class="arrow-down is-active" src="/arrowhead-up-fill.svg" alt="" width="40px" height="40px" data-astro-cid-iws3qlhb> <nav data-astro-cid-iws3qlhb> ${renderComponent($$result, "HamburgerCloseLeft", $$HamburgerCloseLeft, { "data-astro-cid-iws3qlhb": true })} <div data-astro-cid-iws3qlhb> <a href="/" class="globalNav-logo" data-astro-cid-iws3qlhb>${renderComponent($$result, "Image", $$Image, { "class": "logo", "src": logo, "alt": "\u30ED\u30B4", "width": "90", "height": "90", "data-astro-cid-iws3qlhb": true })}</a> </div> </nav> <div class="wrapper" id="js-globalNav-menu" data-astro-cid-iws3qlhb> <div class="menu" data-astro-cid-iws3qlhb> <ul data-astro-cid-iws3qlhb> ${nav.map((nav_item) => renderTemplate`<li data-astro-cid-iws3qlhb> <a${addAttribute(nav_item.href, "href")} data-astro-cid-iws3qlhb>${nav_item.label}</a> </li>`)} </ul> <div class="trigger" data-astro-cid-iws3qlhb></div> </div> </div> </div> </div>  `;
...
const $$Meta = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head><meta charset="utf-8"><!-- <link rel="icon" type="image/svg+xml" href="/favicon.ico" /> --><!-- <link rel="icon" sizes="32x32" href="/favicon.ico" /> --><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta property="og:title"${addAttribute(title, "content")}><meta name="description"${addAttribute(description, "content")}><meta property="og:description"${addAttribute(description, "content")}><link rel="canonical"${addAttribute(canonicalURL, "href")}><meta property="og:url"${addAttribute(canonicalURL, "content")}><meta property="og:site_name"${addAttribute(siteTitle, "content")}><meta property="og:type"${addAttribute(siteType, "content")}><meta property="og:locale"${addAttribute(siteLocale, "content")}><meta name="format-detection" content="email=no,telephone=no"><link rel="icon"${addAttribute(siteIcon, "href")}><link rel="apple-touch-icon"${addAttribute(siteIcon, "href")}><!-- <link rel="preconnect" href="https://fonts.googleapis.com">
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const props = Astro2.props;
  return renderTemplate`<html lang="ja" data-astro-cid-mmggtga4> <head>${renderComponent($$result, "Meta", $$Meta, { ...props, "?": true, "data-astro-cid-mmggtga4": true })}<link rel="sitemap" href="/sitemap-index.xml">${renderHead()}</head> <body id="js-body" data-astro-cid-mmggtga4> <div class="bodyCover" data-astro-cid-mmggtga4></div> <div class="bodyInner" data-astro-cid-mmggtga4> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-mmggtga4": true })} ${renderComponent($$result, "GlobalNavLeft", $$GlobalNavLeft, { "data-astro-cid-mmggtga4": true })} ${renderComponent($$result, "GlobalNavRight", $$GlobalNavRight, { "data-astro-cid-mmggtga4": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-mmggtga4": true })} ${renderComponent($$result, "BottomNav", $$BottomNav, { "data-astro-cid-mmggtga4": true })} </div>  </body> </html>`;
