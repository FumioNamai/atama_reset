import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, k as renderSlot, i as renderComponent } from '../astro_B6h7vYUJ.mjs';
import 'kleur/colors';
...
const thanks2 = new Proxy({"src":"/_astro/thanks2.GeRteJS3.webp","width":453,"height":340,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Documents/プログラミング学習/atama_reset/reset website/src/assets/thanks2.webp";
							}
