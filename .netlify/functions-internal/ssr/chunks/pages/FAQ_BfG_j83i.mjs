...
import { s as styles } from '../FAQ.117d5ef1_BZyMO7BP.mjs';

const QandA = new Proxy({"src":"/_astro/Q_A.Dgxtes9t.webp","width":640,"height":327,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Documents/プログラミング学習/atama_reset/reset website/src/assets/Q&A.webp";
							}
...
詳しくは<a href="/blog/what-is-different-from-190612" data-astro-cid-ynzegj2z>こちら</a> </p> </div>`, "question": ($$result3) => renderTemplate`<span data-astro-cid-ynzegj2z>「ヘッドスパと何が違うの？」</span>` })} </main> ` })} `;
