...
const $$Hamburger = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button class="hamburger" id="js-hamburger" title="hamburger-menu" data-astro-cid-3weo6hls><span data-astro-cid-3weo6hls></span><span data-astro-cid-3weo6hls></span><span data-astro-cid-3weo6hls></span><p class="menu" data-astro-cid-3weo6hls>MENU</p></button>`;
...
頭ほぐし専門店 reset</span></p><div class="hamburger" data-astro-cid-3ef6ksr2>${renderComponent($$result, "Hamburger", $$Hamburger, { "data-astro-cid-3ef6ksr2": true })}</div><div class="logo2" data-astro-cid-3ef6ksr2><a href="/" data-astro-cid-3ef6ksr2>${renderComponent($$result, "Image", $$Image, { "src": logo2, "alt": "\u30ED\u30B4", "width": "81", "height": "48", "loading": "eager", "data-astro-cid-3ef6ksr2": true })}</a></div><div class="logo" data-astro-cid-3ef6ksr2><a href="/" data-astro-cid-3ef6ksr2>${renderComponent($$result, "Image", $$Image, { "src": logo, "alt": "\u30ED\u30B4", "width": "90", "height": "90", "loading": "eager", "data-astro-cid-3ef6ksr2": true })}</a></div><div class="dot" data-astro-cid-3ef6ksr2></div><a href="/contact" class="contact" data-astro-cid-3ef6ksr2>ご予約<span data-astro-cid-3ef6ksr2>・お問い合わせ</span></a></div></header>`;
...
const $$HamburgerClose = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button class="hamburgerClose open" id="js-hamburgerClose" title="hamburger-close" data-astro-cid-dwtncowi><span data-astro-cid-dwtncowi></span><span data-astro-cid-dwtncowi></span></button>`;
...
const $$GlobalNav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="globalNav" id="js-globalNav" data-astro-cid-3cursr6z><div class="container" data-astro-cid-3cursr6z><nav data-astro-cid-3cursr6z>${renderComponent($$result, "HamburgerClose", $$HamburgerClose, { "data-astro-cid-3cursr6z": true })}<div class="logo" data-astro-cid-3cursr6z><a href="/" class="globalNav-logo" data-astro-cid-3cursr6z>${renderComponent($$result, "Image", $$Image, { "src": logo, "alt": "\u30ED\u30B4", "width": "90", "height": "90", "data-astro-cid-3cursr6z": true })}</a></div></nav><div class="wrapper" id="js-globalNav-menu" data-astro-cid-3cursr6z><div class="menu" data-astro-cid-3cursr6z><ul data-astro-cid-3cursr6z>${nav.map((nav_item) => renderTemplate`<li data-astro-cid-3cursr6z><a${addAttribute(nav_item.href, "href")} data-astro-cid-3cursr6z>${nav_item.label}</a></li>`)}</ul></div></div></div></div>`;
...
const siteMeta = {
  ...
  // siteUrl: 'https://main--magenta-jalebi-d1fcd1.netlify.app/',
  siteType: 'website',
  siteLocale: 'ja_JP',
  siteIcon: ''
};
