import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent, g as defineStyleVars, b as addAttribute } from '../astro/server_5b850809.mjs';
import 'clsx';
import { $ as $$Image, a as $$Layout } from './404_e0b52eba.mjs';
/* empty css                           */import { createClient } from 'microcms-js-sdk';
/* empty css                           */import { c as clinic_image3, a as clinic_image4 } from './greeting_9b671e54.mjs';
/* empty css                           */
const hero = new Proxy({"src":"/_astro/hero.9a927950.webp","width":1920,"height":1350,"format":"webp"}, {
...
const client$1 = createClient({
  serviceDomain: "b617jp54c5",
  apiKey: "1KHFXKBXyRnmxiCNit0My9uhBzk715zBxlT9"
});
async function getNews({
  limit
}) {
  const posts = await client$1.get({
    endpoint: "news",
    queries: {
      orders: "-publishedAt",
      limit
...
const $$NewsList = createComponent(async ($$result, $$props, $$slots) => {
  ...
  })}<div class="wrapper" data-astro-cid-zmm3bjuf><p data-astro-cid-zmm3bjuf>${content.title}</p><span data-astro-cid-zmm3bjuf></span></div></div></a>`)}${renderComponent($$result, "MoreButton", $$MoreButton, { "href": "/news", ",": true, "label": "\u3082\u3063\u3068\u898B\u308B", ",": true, "width": "114px", "marginInline": "auto 0", "data-astro-cid-zmm3bjuf": true })}</div></section>`;
...
const refreshing = new Proxy({"src":"/_astro/refreshing.ae87761d.webp","width":900,"height":551,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const $$Features = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="features" data-astro-cid-vnivfuh2><div class="reason" data-astro-cid-vnivfuh2><h3 class="fadein" data-astro-cid-vnivfuh2>選ばれる理由</h3><div class="wrapper" data-astro-cid-vnivfuh2><div class="grid_item one fadein" data-astro-cid-vnivfuh2><h4 data-astro-cid-vnivfuh2><span class="largeNumber" data-astro-cid-vnivfuh2>1</span>整体法を取り入れた施術</h4><p data-astro-cid-vnivfuh2>
整体師監修のもと整体法を取り入れたオールハンドの施術です。
</p></div><div class="grid_item two fadein" data-astro-cid-vnivfuh2><h4 data-astro-cid-vnivfuh2><span class="largeNumber" data-astro-cid-vnivfuh2>2</span>解剖学に基づいた施術</h4><p data-astro-cid-vnivfuh2>
...
</p></div><div class="grid_item three fadein" data-astro-cid-vnivfuh2><h4 data-astro-cid-vnivfuh2><span class="largeNumber" data-astro-cid-vnivfuh2>3</span>科学的に根拠のある施術</h4><p data-astro-cid-vnivfuh2>
...
</span></p>${renderComponent($$result, "MoreButton", $$MoreButton, { "href": "/blog/scientific-basis-211004", ",": true, "label": "\u8A73\u3057\u304F\u306F\u3053\u3061\u3089", "width": "145px", "marginInline": "auto", "data-astro-cid-vnivfuh2": true })}</div><div class="grid_item four  fadein" data-astro-cid-vnivfuh2><h4 data-astro-cid-vnivfuh2><span class="largeNumber" data-astro-cid-vnivfuh2>4</span>ベッドを使っての施術</h4><p data-astro-cid-vnivfuh2>
...
const clinic_image_1 = new Proxy({"src":"/_astro/clinic_image_1.d0897679.webp","width":400,"height":300,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const clinic_image_2 = new Proxy({"src":"/_astro/clinic_image_2.ae66756e.webp","width":400,"height":300,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
</p></div><div class="clinic-image" data-astro-cid-nhua6grl><div class="splide" role="group" aria-label="治療院の画像" id="imageSlider" data-astro-cid-nhua6grl><div class="splide__track" data-astro-cid-nhua6grl><div class="splide__arrows" data-astro-cid-nhua6grl></div><ul class="slider-group fadein splide__list" data-astro-cid-nhua6grl><li class="splide__slide" data-astro-cid-nhua6grl>${renderComponent($$result, "Image", $$Image, { "src": clinic_image_1, "alt": "\u5916\u89B3", "width": "400", "height": "300", "data-astro-cid-nhua6grl": true })}</li><li class="splide__slide" data-astro-cid-nhua6grl>${renderComponent($$result, "Image", $$Image, { "src": clinic_image_2, "alt": "\u5185\u89B31", "width": "400", "height": "300", "data-astro-cid-nhua6grl": true })}</li><li class="splide__slide" data-astro-cid-nhua6grl>${renderComponent($$result, "Image", $$Image, { "src": clinic_image3, "alt": "\u5185\u89B32", "width": "400", "height": "300", "data-astro-cid-nhua6grl": true })}</li><li class="splide__slide" data-astro-cid-nhua6grl>${renderComponent($$result, "Image", $$Image, { "src": clinic_image4, "alt": "\u500B\u5BA4", "width": "400", "height": "300", "data-astro-cid-nhua6grl": true })}</li></ul></div><ul class="splide__pagination" data-astro-cid-nhua6grl></ul></div></div></div></div></section>`;
...
const $$BlogList = createComponent(async ($$result, $$props, $$slots) => {
  ...
  date = new Date(date).toLocaleDateString("ja-JP").split("/").join(".");
