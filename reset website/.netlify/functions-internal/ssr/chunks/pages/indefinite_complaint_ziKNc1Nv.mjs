...
const stiff_neck = new Proxy({"src":"/_astro/stiff_neck.DneSud0l.webp","width":640,"height":427,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Documents/プログラミング学習/atama_reset/reset website/src/assets/stiff_neck.webp";
							}
