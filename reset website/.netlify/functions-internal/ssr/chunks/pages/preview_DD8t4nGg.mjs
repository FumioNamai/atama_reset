import { e as createAstro, f as createComponent, l as defineStyleVars, r as renderTemplate, m as maybeRenderHead, h as addAttribute, i as renderComponent } from '../astro_B6h7vYUJ.mjs';
import 'kleur/colors';
...
const $$BackButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="backButton" data-astro-cid-7a7bzblm${addAttribute($$definedVars, "style")}> <a${addAttribute(href, "href")} class="back" data-astro-cid-7a7bzblm${addAttribute($$definedVars, "style")}>${label}</a> <span data-astro-cid-7a7bzblm${addAttribute($$definedVars, "style")}></span> </div> `;
