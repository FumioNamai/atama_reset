import { e as createAstro, f as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead, h as addAttribute, u as unescapeHTML } from '../astro_B6h7vYUJ.mjs';
import 'kleur/colors';
import { a as $$Layout } from './404_ClvMmi_J.mjs';
import { g as getNews } from './index_BP6RgzDp.mjs';
/* empty css                         */
...
const $$News = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "pageTitle": "\u304A\u77E5\u3089\u305B", "description": "", "data-astro-cid-5kj6t6lp": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-5kj6t6lp> <section data-astro-cid-5kj6t6lp> <h2 data-astro-cid-5kj6t6lp>お知らせ</h2> ${data.map((content) => renderTemplate`<div class="container" data-astro-cid-5kj6t6lp> ${content.pubDateDisplay ? renderTemplate`<p class="publishedAt" data-astro-cid-5kj6t6lp>${content.publishedAt}</p>` : renderTemplate`<div data-astro-cid-5kj6t6lp></div>`} ${content.tag.map((tag) => {
    switch (tag) {
      case "\u91CD\u8981":
